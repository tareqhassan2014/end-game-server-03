...
const hostelRouter = require('./resource/hostel/hostel.router');
const storeRouter = require('./resource/store/store.router');
const userRouter = require('./resource/user/user.router');
const hostelsAdRouter = require('./resource/hostelsAd/hostelsAd.router');
